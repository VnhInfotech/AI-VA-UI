    ...
    <div className="pt-10 flex items-center justify-center min-h-screen">
      <div className="w-full max-w-md p-8 rounded-lg">
        ...
        <div className="flex flex-col items-center mb-6 cursor-pointer transition">
          <div className="flex items-center space-x-2 cursor-pointer transition"
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4 relative">
            <input
              ...
              className="w-full pr-12 pl-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[rgba(199,48,207,0.8)]"
              required
              value={password}
          ...
          <div className="text-right mb-4">
            <a
              ...
              className="text-[#C730CF] text-sm font-medium"
            >
              Forgot Password?
            </a>
          </div>
    ...
    <button className="w-full flex items-center justify-center border py-3 rounded-lg mt-2 hover:bg-gray-200">
      ...
      &nbsp; Sign in with Apple
        ...
        <p className="text-right mt-2.5 text-sm font-medium">
          ...
          <a href="/signup" className="text-[#C730CF]">
            Sign up
          </a>
        </p>
      </div>
